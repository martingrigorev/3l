...
export default function App() {
  ...
  if (mode === 'sea_animals') {
    return <SeaAnimalsMenu onBack={() => setMode('menu')} onSelectAnimal={handleStartSeaAnimalsGame} />;
  }
  ...
  return (
    <div className="h-[100dvh] w-full grid grid-cols-3 grid-rows-3 bg-neutral-900 overflow-hidden">
      ...
      {/* Placeholders 3-8 (Cool/Muted Tones Only) */}
      ...
      <div className="bg-emerald-900 border border-neutral-800 opacity-60" />
